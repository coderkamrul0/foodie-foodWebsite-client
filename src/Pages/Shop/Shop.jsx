...
const Shop = () => {
  ...
  const filteredFood = allFood.filter((item) => {
    const categoryMatch =
      selectedCategory === "" || item.foodCategory === selectedCategory;
    const searchMatch = item.foodName
      .toLowerCase()
    ...
    <div>
      ...
      <div className="max-w-screen-xl mx-auto py-10">
        <div className="md:flex justify-between items-center py-3">
          <div>
            <label htmlFor="category" className="px-2 py-1">
              Filter by Category
            </label>
            <select
              id="category"
          ...
          <div>
            <label htmlFor="sortOrder" className="px-2 py-1">
              Sort by Price
            </label>
            <select
              id="sortOrder"
